...
public class MethodCallActualParams extends MethodCall {

    private Designator Designator;
    private ActualParams ActualParams;

    public MethodCallActualParams (Designator Designator, ActualParams ActualParams) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodCallActualParams(\n");
