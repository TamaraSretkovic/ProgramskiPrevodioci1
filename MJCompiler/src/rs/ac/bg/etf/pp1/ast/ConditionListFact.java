...
public class ConditionListFact extends ConditionTerm {

    private ConditionTerm ConditionTerm;
    private ConditionFact ConditionFact;

    public ConditionListFact (ConditionTerm ConditionTerm, ConditionFact ConditionFact) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionListFact(\n");
