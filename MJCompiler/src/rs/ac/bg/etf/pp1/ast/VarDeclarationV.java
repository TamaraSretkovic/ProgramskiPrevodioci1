...
public class VarDeclarationV extends VarDeclaration {

    private VarType VarType;
    private VarDeclarationList VarDeclarationList;

    public VarDeclarationV (VarType VarType, VarDeclarationList VarDeclarationList) {
