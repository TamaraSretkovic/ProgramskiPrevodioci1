...
public class DeclarationListDeclaration extends DeclarationList {

    private DeclarationList DeclarationList;
    private Declaration Declaration;

    public DeclarationListDeclaration (DeclarationList DeclarationList, Declaration Declaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationListDeclaration(\n");
