...
public class ConditionListTerm extends Condition {

    private Condition Condition;
    private ConditionTerm ConditionTerm;

    public ConditionListTerm (Condition Condition, ConditionTerm ConditionTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionListTerm(\n");
