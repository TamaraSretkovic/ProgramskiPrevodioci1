...
public class MethodDeclarationListMethod extends MethodDeclarationList {

    private MethodDeclarationList MethodDeclarationList;
    private MethodDeclaration MethodDeclaration;

    public MethodDeclarationListMethod (MethodDeclarationList MethodDeclarationList, MethodDeclaration MethodDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MethodDeclarationListMethod(\n");
